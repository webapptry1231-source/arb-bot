#!/usr/bin/env python3
"""
NicheMultiHopArbBot - Multi-Chain Flash Loan Arbitrage Scanner (v10.5)
...
# ============================================================================
# Chain Configurations (all checksummed)
# ============================================================================
CHAIN_CONFIGS = {
    'monad': ChainConfig(
        name='Monad',
...
STABLE_TOKENS = {
    ...
    'sonic': [
        ...
        TokenConfig('USDT', '0x6047828dC181963BA44974801ff68e538DA5eAf9', 6, True),   # checksummed
...
# ============================================================================
# DEX Configurations (all checksummed)
# ============================================================================
DEX_CONFIGS = {
    'monad': [
...
class TokenGraph:
    ...
    async def _fetch_v3_pools(self, dex: DEXConfig):
        ...
        # Ensure all tokens are checksummed
        known_tokens = [Web3.to_checksum_address(t) for t in known_tokens]
    ...
    async def fetch_token_decimals(self, address: str) -> int:
        ...
        try:
            ...
            self.token_decimals[addr] = dec
            return dec
        except Exception:
            self.token_decimals[addr] = 18
            return 18
...
if __name__ == "__main__":
    asyncio.run(main())# Chain Configurations (all filled)
# ============================================================================
CHAIN_CONFIGS = {
    'monad': ChainConfig(
        name='Monad',
